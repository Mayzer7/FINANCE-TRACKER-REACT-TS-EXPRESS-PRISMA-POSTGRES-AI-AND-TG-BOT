...
Не используй markdown-разметку, символы **, __, #, обратные кавычки, таблицы, code blocks и декоративные заголовки.
Если нужен список, оформляй его простым текстом: каждая новая мысль с новой строки, без markdown-декора.
